package com.ershi.aspider.analysis.agent.rule;

import com.ershi.aspider.analysis.agent.core.AgentContext;
 ...
 * 趋势规则引擎
 *
 * 承载原TrendAgent的规则逻辑，作为LLM降级时的备选方案
 *
 * @author Ershi-Gu
 */
@Component
@Slf4j
public class TrendRuleEngine {
    ...
    public TrendSignal analyze(AgentContext context) {
        log.info("TrendRuleEngine 执行规则分析");
        ...
        log.info("TrendRuleEngine 分析完成，信号={}，方向={}", signal, indicator.getDirection());
